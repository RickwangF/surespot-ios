...
-(UIImage *) generateQRInviteImage: (NSString *) username {
    ...
    NSString * inviteUrl = [NSString stringWithFormat:@"https://invite.surespot.me/autoinvite/%@%@", [username stringByAddingPercentEscapesUsingEncoding: NSUTF8StringEncoding], @"/qr_ios"];
